...
function ProductList({ onHomeClick }) {
  ...
  const [addedToCart, setAddedToCart] = useState(); // State to control "Add to Cart" user interaction

  const dispatch = useDispatch();
  const cartItems = useSelector(state => state.cart.items); // Get cart items globally
        ...
        <div style={styleObjUl}>
          ...
          <div>
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <span className='cart_quantity_count'>{totalAmount}</span>
